...
HD_PWD='C:/Users/marie/Desktop/Pise/ElectronicSystems/Lab/TP/MiniRouter/Vivado/Mini_Router.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MINI_ROUTER_WRAPPER.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MINI_ROUTER_WRAPPER.tcl -notrace
