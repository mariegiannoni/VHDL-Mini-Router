...
HD_PWD='C:/Users/marie/Desktop/Pise/ElectronicSystems/Lab/TP/MiniRouter/Vivado/Mini_Router.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MINI_ROUTER_WRAPPER.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MINI_ROUTER_WRAPPER.tcl
